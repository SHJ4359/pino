...
//     	 console.log(filename);
     ...
     $("#btnSubmit").click(function() {
    	 ...
    	 var cmp_reg_image = $("#cmp_reg_image").val();
    	 $("input[name=cmp_reg_image]").val(cmp_reg_image);
...
<div>
	...
	<form action="/insa/update" method="post" id="formAction">
		<div>
	<div class="container col-sm-12 sub_content">
	<h2>직원 정보 수정</h2><br>
	</div>
			<div style="float: right;margin-right: 20px;margin-bottom: 10px;">
				<input type="button" value="수정" class="btn btn-default" id="btnSubmit">
		...
		<div class="col-md-12">
			<div class="col-md-3" style="text-align: center;">
				<c:choose>
					<c:when test="${ insaVo.profile eq 'null' }">
						<img alt="basic-img" src="/resources/images/profileimage.jpg" style="height: 250px;">
					</c:when>
					<c:otherwise>
						<img alt="basic-img" src="/file/display?fileName=${ insaVo.profile }" style="height: 250px;">
					</c:otherwise>
				</c:choose>
				<br>
				<input type="button" value="사진올리기" class="btn btn-default" id="btn-profile" data-img="${ insaVo.profile }" >
			...
			<div class="col-md-9 form-group">
				<div class="col-md-4">
					...
					<input type="text" id="sabun" name="sabun" class="col-md-8 form-control" readonly="readonly" value="${ sabun }">
				</div>
				<div class="col-md-4">
					...
					<input type="text" id="name" name="name" class="col-md-8 form-control" placeholder="영어만 입력하세요." value="${ insaVo.name }">
				</div>
				<div class="col-md-4">
					...
					<input type="text" id="eng_name" name="eng_name" class="col-md-8 form-control" placeholder="영어만 입력하세요." value="${ insaVo.eng_name }">
				</div>
			</div>
			<div class="col-md-9 form-group">
				<div class="col-md-4">
					...
					<input type="text" id="id" name="id" class="col-md-8 form-control" placeholder="영어와 숫자만 입력하세요." value="${ insaVo.id }">
				</div>
				<div class="col-md-4">
			...
			<div class="col-md-9 form-group">
				<div class="col-md-4">
					...
					<input type="text" id="phone" name="phone" class="col-md-8 form-control" value="${ insaVo.phone }" placeholder="-을(를) 빼고 입력하세요.">
				</div>
				<div class="col-md-4">
					...
					<input type="text" id="hp" name="hp" class="col-md-8 form-control" value="${ insaVo.hp }" placeholder="-을(를) 빼고 입력하세요.">
				</div>
				<div class="col-md-4">
					...
					<input type="text" id="reg_no" class="col-md-8 form-control" value="${ insaVo.reg_no }" placeholder="-을(를) 빼고 입력하세요." maxlength="14">
			...
			<div class="col-md-9 form-group">
				<div class="col-md-4">
					...
					<input type="text" id="years" name="years" class="col-md-8 form-control" value="${ insaVo.years }">
				</div>
				<div class="col-md-4">
					<div class="col-md-6">
						...
						<input type="text" id="email" class="col-md-8 form-control" value="${ insaVo.email }">
					</div>
					<div class="col-md-6">
						...
						<select class="col-md-10 form-control" id="email-back">
							<c:forEach var="insaCom" items="${ getInsaCom }">
								...
								<option value="${ insaCom.name }" <c:if test="${ insaCom.name eq insaVo.email }">selected</c:if>>${ insaCom.name }</option>
								</c:if>
							</c:forEach>
						</select>
					</div>
					...
					<div class="col-md-6">
						...
						<select id="job_type" name="job_type" class="col-md-6 form-control" >
							<c:forEach var="insaCom" items="${ getInsaCom }">
								...
								<option value="${ insaCom.name }" <c:if test="${ insaCom.name eq insaVo.job_type }">selected</c:if>>${ insaCom.name }</option>
								</c:if>
							</c:forEach>
						</select>
					</div>
					<div class="col-md-6">
						...
						<select class="form-control col-md-8" id="sex" name="sex">
							<c:forEach var="insaCom" items="${ getInsaCom }">
								...
								<option value="${ insaCom.name }" <c:if test="${ insaCom.name eq insaVo.sex }">selected</c:if>>${ insaCom.name }</option>
								</c:if>
							</c:forEach>
						</select>
					</div>
			...
			<div class="col-md-9 form-group">
				<div class="col-md-4">
						...
						<input type="text" class="col-md-5 form-control" placeholder="우편번호"  id="zip" name="zip" value="${ insaVo.zip }">
					<div class="col-md-3">
						<input type="button" value="주소검색" id="btn-search" class="btn btn-default">
					</div>
				</div>
				
				<div class="col-md-4">
					<input type="text" id="addr1" name="addr1" placeholder="주소" class="col-md-12 form-control" value="${ insaVo.addr1 }">
				</div>
				
				<div class="col-md-4">
					<input type="text" id="addr2" name="addr2" placeholder="세부주소" class="col-md-12 form-control" value="${ insaVo.addr2 }">
				</div>
			</div>
			...
			<div class="col-md-9 form-group">
					...
					<label class="col-md-4" style="text-align: center;margin-top: 5px;">직위</label>
						<select id="pos_gbn_code" name="pos_gbn_code" class="col-md-8 form-control">
							<c:forEach var="insaCom" items="${ getInsaCom }">
								...
								<option value="${ insaCom.name }" <c:if test="${ insaCom.name eq insaVo.pos_gbn_code }">selected</c:if>>${ insaCom.name }</option>
								</c:if>
							</c:forEach>
						</select>
				</div>
					...
					<label class="col-md-4" style="text-align: center;margin-top: 5px;">부서</label>
						<select id="dept_code" name="dept_code" class="col-md-8 form-control">
							<c:forEach var="insaCom" items="${ getInsaCom }">
								...
								<option value="${ insaCom.name }" <c:if test="${ insaCom.name eq insaVo.dept_code }">selected</c:if>>${ insaCom.name }</option>
								</c:if>
							</c:forEach>
						</select>
				</div>
				<div class="col-md-4" >
					...
					<input type="text" id="show-salary" class="col-md-8 form-control" placeholder="(만원)" value="${ insaVo.salary }" style="float: right;">
				...
				<label class="col-md-4" style="text-align: center;margin-top: 5px;">입사구분</label>
						<select id="join_gbn_code" name="join_gbn_code" class="col-md-8 form-control">
							<c:forEach var="insaCom" items="${ getInsaCom }">
								...
								<option value="${ insaCom.name }" <c:if test="${ insaCom.name eq insaVo.join_gbn_code }">selected</c:if>>${ insaCom.name }</option>
								</c:if>
							</c:forEach>
						</select>
			</div>
				...
				<label class="col-md-4" style="text-align: center;margin-top: 5px;">등급</label>
						<select id="gart_level" name="gart_level" class="col-md-8 form-control">
							<c:forEach var="insaCom" items="${ getInsaCom }">
								...
								<option value="${ insaCom.name }" <c:if test="${ insaCom.name eq insaVo.gart_level }">selected</c:if>>${ insaCom.name }</option>
								</c:if>
							</c:forEach>
						</select>
			</div>
				...
				<label class="col-md-4" style="text-align: center;margin-top: 5px;">투입여부</label>
					<select id="put_yn" name="put_yn" class="col-md-8 form-control">
						<c:forEach var="insaCom" items="${ getInsaCom }">
							...
							<option value="${ insaCom.name }" <c:if test="${ insaCom.name eq insaVo.put_yn }">selected</c:if>>${ insaCom.name }</option>
							</c:if>
						</c:forEach>
					</select>
			</div>
			<div class="col-md-3">
				...
				<select id="mil_yn" name="mil_yn" class="col-md-8 form-control">
					<c:forEach var="insaCom" items="${ getInsaCom }">
						...
						<option value="${ insaCom.name }" <c:if test="${ insaCom.name eq insaVo.mil_yn }">selected</c:if>>${ insaCom.name }</option>
						</c:if>
					</c:forEach>
				</select>
			</div>
		...
		<div class="mil_test">
			<div class="col-md-3">
				...
				<select id="mil_type" name="mil_type" class="col-md-8 form-control">
					<c:forEach var="insaCom" items="${ getInsaCom }">
						...
						<option value="${ insaCom.name }" <c:if test="${ insaCom.name eq insaVo.mil_type }">selected</c:if>>${ insaCom.name }</option>
						</c:if>
					</c:forEach>
				</select>
			</div>
			<div class="col-md-3">
				...
				<select id="mil_level" name="mil_level" class="col-md-8 form-control">
					<c:forEach var="insaCom" items="${ getInsaCom }">
						...
						<option value="${ insaCom.name }" <c:if test="${ insaCom.name eq insaVo.mil_level }">selected</c:if>>${ insaCom.name }</option>
						</c:if>
					</c:forEach>
				</select>
			</div>
			...
			<div class="col-md-3">
				...
				<input type="text" id="datepicker1" name="mil_startdate" class="col-md-7 form-control" readonly="readonly" value="${ insaVo.mil_startdate }">
			</div>
			<div class="col-md-3">
				<label class="col-md-4" style="text-align: center; margin-top: 5px;">전역일자</label>
				<input type="text" id="datepicker2" name="mil_enddate"  class="col-md-7 form-control" readonly="readonly" value="${ insaVo.mil_enddate }">
			</div>
		</div>
		...
		<div class="col-md-12 for-group">
			<div class="col-md-3">
				...
				<select id="kosa_reg_yn" name="kosa_reg_yn" class="col-md-8 form-control">
					<c:forEach var="insaCom" items="${ getInsaCom }">
						...
						<option value="${ insaCom.name }" <c:if test="${ insaCom.name eq insaVo.kosa_reg_yn }">selected</c:if>>${ insaCom.name }</option>
						</c:if>
					</c:forEach>
				</select>
			</div>
			<div class="col-md-3">
				...
				<select id="kosa_class_code" name="kosa_class_code" class="col-md-8 form-control">
					<c:forEach var="insaCom" items="${ getInsaCom }">
						...
						<option value="${ insaCom.name }" <c:if test="${ insaCom.name eq insaVo.kosa_class_code }">selected</c:if>>${ insaCom.name }</option>
						</c:if>
					</c:forEach>
				</select>
			</div>
			<div class="col-md-3">
				...
				<input type="text" id="datepicker3" class="col-md-7 form-control" readonly="readonly" name="join_day" value="${ insaVo.join_day }">
			</div>
			<div class="col-md-3">
				<label class="col-md-4" style="text-align: center;margin-top: 5px;">퇴사일자</label>
				<input type="text" id="datepicker4" class="col-md-7 form-control" readonly="readonly" name="retire_day" value="${ insaVo.retire_day }">
			</div>
		</div>
		...
		<div class="col-md-12 for-group">
			<div class="col-md-3">
				...
				<div class="location-top"><span id="cmp_reg_no-span" style="z-index: 100000;"></span></div>
				<input class="col-md-8 form-control" type="text" id="cmp_reg_no" name="cmp_reg_no" maxlength="12" value="${ insaVo.cmp_reg_no }">
			</div>
			<div class="col-md-3">
				<label class="col-md-4" style="text-align: center;margin-top: 5px;">업체명</label>
				<input type="text" id="crm_name" name="crm_name" class="col-md-8 form-control" value="${ insaVo.crm_name }">
			</div>
			<div class="col-md-3">
				<label class="col-md-4" style="text-align: center;margin-top: 5px;">사업자등록증</label>
				<input type="text" id="cmp_reg_image" class="col-md-8 form-control" readonly="readonly" value="${ imageDto.cmpName}">
				<input type="hidden" name="cmp_reg_image" id="cmp_hidden_image">
			</div>
			<div class="col-md-3">
				<div class="col-md-12">
					<div class="col-md-6">
						<input type="button" value="미리보기" id="modal-cmp" class="col-md-12 btn btn-default" data-img="${ insaVo.cmp_reg_image }">
					</div>
					<div class="col-md-6">
		...
		<div class="col-md-12 for-group">
			<div class="col-md-6">
				...
				<textarea class="col-md-10 form-control" placeholder="100자 내외로 적으시오" cols="10" id="self_intro" name="self_intro">${ insaVo.self_intro }</textarea>
			</div>
			<div class="col-md-3">
				<label class="col-md-4" style="text-align: center;margin-top: 5px;">이력서</label>
				<input type="text" id="carrier" class="col-md-8 form-control" readonly="readonly" value="${ imageDto.carrierName }">
				<input type="hidden" name="carrier" id="hidden_carrier">
			</div>
			<div class="col-md-3">
				<div class="col-md-12">
					<div class="col-md-6">
						<input type="button" value="미리보기" id="modal_carrier" class="col-md-12 btn btn-default"  data-img="${ insaVo.carrier }">
					</div>
					<div class="col-md-6">
